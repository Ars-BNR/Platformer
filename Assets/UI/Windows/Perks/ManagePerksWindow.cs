...
namespace Platformer.UI.Perks
{
    ...
    public class ManagePerksWindow : AnimatedWindow
    {
        ...
        [SerializeField] private ItemWidgets _price;
        ...
        private void OnPerksChanged()
        {
            ...
            _useButton.gameObject.SetActive(_session.PerksModel.IsUncloked(selected));
            _useButton.interactable = _session.PerksModel.Used != selected;

            _buyButton.gameObject.SetActive(!_session.PerksModel.IsUncloked(selected));
